...
from ui.widgets.content_box_formatter import ContentBoxFormatter  # Phase 14
...
class ContentBoxWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        # Connect cursor position change to sync toolbar state (MS Word-like behavior)
        self.text_editor.cursorPositionChanged.connect(self.formatter.sync_toolbar_state)
