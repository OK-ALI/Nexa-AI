...
class YouTubeService:
    ...
    def __init__(self, config=None):
        ...
        logger.info(f"🎬 YouTube service initialized (yt-dlp available: {YT_DLP_AVAILABLE})")
    ...
    def download_youtube(self, query: str, audio_only: bool = False, quality: str = "1080p") -> str:
        """
        Download a YouTube video (MP4) or audio (MP3) by query or URL.
        ...
        try:
            ...
            mode_str = "audio (MP3)" if audio_only else f"video ({quality} MP4)"
