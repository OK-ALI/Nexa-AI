...
try:
    ...
    from core.memory.intelligent_learner import get_intelligent_learner, IntelligentLearner
...
class ContextManager:
    ...
    def set_event_bus(self, event_bus) -> None:
        ...
        logger.info("🔗 ContextManager connected to EventBus for memory sync")
            ...
            if self.smart_memory:
                ...
                def store_async():
                    try:
                        ...
                        # Notify listeners (Memory Panel) that new memory was stored
                        if self._event_bus:
                            self._event_bus.publish("memory.updated", source="conversation")
                    except Exception as e:
                ...
                def learn_async():
                    try:
                        ...
                        if facts_learned > 0:
                            ...
                            # Notify listeners that knowledge was learned
                            if self._event_bus:
                                self._event_bus.publish("memory.updated", source="learning")
                    except Exception as e:
