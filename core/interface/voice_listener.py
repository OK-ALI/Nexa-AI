...
class AudioListener:
    ...
    def _recording_loop(self):
        ...
        try:
            ...
            is_speaking = False
            speech_confidence_threshold = 0.25  # Silero VAD confidence threshold (25% for more sensitive listening)
            min_start_confidence = 0.25  # Lowered to 25% for easier voice detection
